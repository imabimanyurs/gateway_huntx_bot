...
# List of known payment gateways (Expanded List)
PAYMENT_GATEWAYS = [
    # Global Providers
...
def is_rate_limited(user_id: int) -> bool:
    ...
    user_requests[user_id] = [t for t in user_requests[user_id] if current_time - t < timedelta(minutes=1)]
...
# Function to get fully rendered HTML using Playwright
